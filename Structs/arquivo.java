...
public class arquivo {
  ...
  private static filme stringCSVToFilme(String linha, filme f)
      throws IOException {
  ...
  public static Boolean salvarRegistro(filme f, BTree arvore)
      throws IOException {
    arvore.insert(f);
    boolean resp = true;
    byte[] ba;
    ...
    while (arq.getFilePointer() < arq.length()) {
      ...
      if (lapide == false) {
        ...
        BufferedWriter bw = new BufferedWriter(
            new FileWriter("saidas/saida.txt", true));
        bw.append(
            (f.getId()) +
                "\n" +
                "NOME: " +
  ...
  public static void createStruct(String path, BTree arvore)
      throws IOException {
    String linha = "";
  ...
  public static void createStruct(String path, HashDinamico hash)
      throws IOException {
    String linha = "";
    FileReader isr = new FileReader("Banco/NetFlix.csv"); // Abre o arquivo para escrita e leitura.
    BufferedReader br = new BufferedReader(isr);
  ...
  public static void printList(List<filme> list, int num) throws IOException {
    BufferedWriter writer = new BufferedWriter(
        new FileWriter("saidas/saidaListaInvertida1.txt"));
    if (num == 1) {
  ...
  public static void printList(List<filme> list, String genero)
      throws IOException {
    BufferedWriter writer = new BufferedWriter(
        new FileWriter("saidas/saidaListaInvertida2.txt", true));
  ...
  public static void listarCasamento(List<filme> arr) throws IOException {
    BufferedWriter writer = new BufferedWriter(
        new FileWriter("saidas/saidaForcaBruta.txt"));
